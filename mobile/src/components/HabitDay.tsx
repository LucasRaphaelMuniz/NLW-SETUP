...
export const DAY_SIZE = (Dimensions.get('screen').width / WEEK_DAYS) - (SCREEN_HORIZONTAL_PADDING + 6);
...
export function HabitDay( {amountofHabits = 0, amountCompleted = 0, date, ...rest}: Props) {
  ...
  const amountAccomplishedPercentage = amountofHabits > 0 ? generateProgessPercentage(amountofHabits, amountCompleted): 0;
